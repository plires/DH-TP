...
@section('content')
    ...
    <div class="small-12 columns">
      ...
      <ul id="preguntas" class="margin_bottom_30">
        <li><a class="faq_preguntas btn-link" href="#productos">Que productos comercializamos?</li></a>
        <li><a class="faq_preguntas btn-link" href="#servicios">Ofrecen servicios para eventos?</li></a>
        <li><a class="faq_preguntas btn-link" href="#pagos">Cuáles son las formas de pago?</li></a>
        <li><a class="faq_preguntas btn-link" href="#terminos">Cuáles son los términos y condiciones del sitio?</li></a>
      </ul>
